...
export const metadata: Metadata = {
  title: 'Emergency Locksmith in Chorlton | 24/7 Fast Response | UK Lock',
  description: 'Need an emergency locksmith in Chorlton? UK Lock provides 24/7 fast response for home, business & vehicle lockouts. Non-destructive entry specialists with 20-minute response times.',
  openGraph: {
    title: 'Emergency Locksmith in Chorlton | 24/7 Fast Response | UK Lock',
    description: 'Need an emergency locksmith in Chorlton? UK Lock provides 24/7 fast response for home, business & vehicle lockouts. Non-destructive entry specialists with 20-minute response times.',
    url: 'https://www.uklock.co.uk/locations/manchester/chorlton/emergency-locksmith',
    siteName: 'UK Lock',
    locale: 'en_GB',
    type: 'website',
  },
  ...
  alternates: {
    canonical: 'https://www.uklock.co.uk/locations/manchester/chorlton/emergency-locksmith',
  },
}

export default function EmergencyLocksmithChorlton() {
  return (
    <main className="flex-1">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col items-center text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Emergency Locksmith in Chorlton
            </h1>
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl">
              Locked out? Key broken? Lock damaged? Our 24/7 emergency locksmith service in Chorlton provides fast, reliable solutions when you need them most.
            </p>
      ...
      <section id="services" className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">Our Emergency Locksmith Services in Chorlton</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-700 mb-4">
                Locked out of your home in Chorlton? Our emergency locksmiths can quickly gain access to your property using non-destructive entry techniques, minimizing damage and stress.
              </p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-700 mb-4">
                Business security issues in Chorlton? Our emergency locksmiths can help with office lockouts, shop security problems, and commercial property access issues.
              </p>
              <ul className="text-gray-700 space-y-2">
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0" />
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-700 mb-4">
                Locked keys in your car in Chorlton? Our auto locksmith specialists can quickly gain access to your vehicle without causing damage to your car.
              </p>
              <ul className="text-gray-700 space-y-2">
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0" />
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-700 mb-4">
                Key snapped in the lock? Our Chorlton emergency locksmiths can extract broken keys from any lock without damaging the mechanism, then cut you a new key on the spot.
              </p>
              <ul className="text-gray-700 space-y-2">
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0" />
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-700 mb-4">
                Damaged or faulty lock in Chorlton? Our emergency locksmiths can repair or replace any type of lock on the spot, restoring your security as quickly as possible.
              </p>
              <ul className="text-gray-700 space-y-2">
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0" />
            ...
            <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-700 mb-4">
                Been a victim of a break-in in Chorlton? Our emergency locksmiths can secure your property quickly, repairing or replacing damaged locks and upgrading your security.
              </p>
              <ul className="text-gray-700 space-y-2">
                <li className="flex items-center">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-2 flex-shrink-0" />
      ...
      <section className="py-16 px-4 bg-blue-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">Fast Response in Chorlton</h2>
          ...
          <div className="bg-white p-8 rounded-xl shadow-md">
            <div className="flex flex-col md:flex-row items-center mb-8">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-800 mb-2">Average Response Times in Chorlton</h3>
                <p className="text-gray-700">
                  When you're facing a lockout emergency, every minute counts. Our dedicated Chorlton emergency locksmith team aims to reach you as quickly as possible.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="text-xl font-bold text-blue-800 mb-2">Chorlton Central</h4>
                <p className="text-gray-700 mb-2">Average response time:</p>
                <p className="text-2xl font-bold text-blue-600">15-20 minutes</p>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="text-xl font-bold text-blue-800 mb-2">Chorlton Park</h4>
                <p className="text-gray-700 mb-2">Average response time:</p>
                <p className="text-2xl font-bold text-blue-600">20-25 minutes</p>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg">
                <h4 className="text-xl font-bold text-blue-800 mb-2">Chorlton Outskirts</h4>
                <p className="text-gray-700 mb-2">Average response time:</p>
                <p className="text-2xl font-bold text-blue-600">25-30 minutes</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-md text-center">
              ...
              <p className="text-gray-700">
                Contact our 24/7 emergency number for immediate assistance in Chorlton.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md text-center">
              ...
              <p className="text-gray-700">
                Our Chorlton locksmith will arrive promptly, usually within 15-25 minutes.
              </p>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
              ...
              <p className="text-lg text-gray-700 mb-4">
                At UK Lock, our Chorlton emergency locksmiths specialize in non-destructive entry techniques. This means we can get you back into your property without causing unnecessary damage to your doors or locks.
              </p>
              <p className="text-lg text-gray-700 mb-4">
      ...
      <section className="py-16 px-4 bg-blue-600 text-white">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-8">24/7 Emergency Locksmith Service in Chorlton</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Locksmith emergencies don't follow a 9-to-5 schedule. That's why our Chorlton emergency locksmith team is available 24 hours a day, 7 days a week, 365 days a year.
          </p>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-blue-700 p-6 rounded-xl">
              ...
              <p>
                Locked out after a night out in Chorlton? We're just a phone call away, any time of night.
              </p>
            </div>
            <div className="bg-blue-700 p-6 rounded-xl">
              <div className="bg-blue-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
              ...
              <p>
                Emergencies don't take holidays, and neither do we. Available throughout Chorlton on weekends and bank holidays.
              </p>
            </div>
            <div className="bg-blue-700 p-6 rounded-xl">
              <div className="bg-blue-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
              ...
              <p>
                Our Chorlton emergency team is always ready to respond, with locksmiths on standby 24/7.
              </p>
            </div>
          </div>
          <div className="mt-12">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">Why Choose Our Chorlton Emergency Locksmith Service</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-700">
                Our Chorlton emergency locksmiths aim to reach you within 15-25 minutes, minimizing your wait time during stressful situations.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-700">
                All our Chorlton emergency locksmiths are fully qualified, DBS checked, and extensively trained in the latest locksmith techniques.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-700">
                We provide clear, upfront pricing with no hidden fees or call-out charges, even for emergency locksmith services in Chorlton.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-700">
                Our Chorlton emergency locksmith service is highly rated on Google, Checkatrade, and Trustpilot, with hundreds of 5-star reviews.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-700">
                Our emergency locksmith service in Chorlton is available 24 hours a day, 7 days a week, including nights, weekends, and bank holidays.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-gray-100">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">Emergency Locksmith Coverage in Chorlton</h2>
          
          <p className="text-lg text-center mb-8">
            Our emergency locksmith services cover all areas of Chorlton and surrounding regions, including:
          </p>
          
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <div className="bg-blue-100 rounded-lg p-3 text-center text-blue-800 font-medium">Chorlton Central</div>
            <div className="bg-blue-100 rounded-lg p-3 text-center text-blue-800 font-medium">Chorlton Park</div>
          ...
          <p className="text-center mt-8 text-gray-700">
            Don't see your area listed? Don't worry - we cover the entire Chorlton area and beyond. Just give us a call to confirm our availability for your location.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-xl font-bold mb-3 text-gray-800">How quickly can you reach me in Chorlton?</h3>
              <p className="text-gray-700">
                Our average response time for emergency locksmith callouts in Chorlton is 15-25 minutes. For central Chorlton locations, we can often arrive within 15-20 minutes. Response times may vary slightly depending on time of day, traffic conditions, and your exact location.
              </p>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-xl font-bold mb-3 text-gray-800">Do you charge a call-out fee for emergency locksmith services in Chorlton?</h3>
              <p className="text-gray-700">
                No, we don't charge any call-out fees for our emergency locksmith services in Chorlton, even for late-night, weekend, or holiday callouts. You only pay for the work carried out.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-700">
                Our Chorlton emergency locksmiths are trained to open virtually all types of locks, including UPVC door locks, mortice locks, euro cylinders, smart locks, car locks, and high-security locks. We use non-destructive entry methods whenever possible.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-700">
                Yes, our Chorlton emergency locksmiths can help if you've lost all your keys. We can gain entry to your property, then replace your locks or rekey them as needed. For vehicles, we can create new keys even if you have no spare.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <p className="text-gray-700">
                Yes, if your property in Chorlton has been broken into and your door or window is damaged, we can provide emergency boarding-up services to secure your property temporarily until permanent repairs can be made.
              </p>
            </div>
          </div>
        </div>
